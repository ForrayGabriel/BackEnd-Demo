...
const uri = "mongodb+srv://admin:adpassminword@forrayg0.pr81v.mongodb.net/LaFerme?retryWrites=true&w=majority";
...
const especeRoutes = require('./routes/espece');

//Acces the routes 
app.use('/api/v1/', especeRoutes);
